<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Печать на подушках',
    'longtitle' => '',
    'description' => '',
    'alias' => 'pechat-na-podushkax',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    'parent' => 4,
    'isfolder' => 0,
    'introtext' => 'Отличным подарком для ваших друзей и близких станет подушка с фотографией. Наша компания выполняет качественную печать фото на подушке в короткие сроки. ',
    'content' => '<div style="margin: 0 auto 80px; font-family: \'Roboto Light\', \'Calibry\';">
<h2>Конструктор подушек</h2>
<hr />
<div class="container inclide_box" style="margin-top: 20px;">
...
<div class="col-xs-6 pull-right">
    <h4 class="phone_title_cr">Подушка квадрат 34х34 см</h4>
    <span class="price_pill_cr"><span class="price_pill_value">800</span> Руб.</span>

    <h3 class="constr_h3">Выберите подушку:</h3>

    <div class="form-group">
        <div class="FonBoxPills">
            <div class="fon-item" onclick="changeColorPill(\'assets/images/pills_variants/gold-pillow.png\');"><img src="assets/images/pills_variants/gold-pillow-min.png" alt="" /></div>
            <div class="fon-item" onclick="changeColorPill(\'assets/images/pills_variants/lgold-pillow.png\');"><img src="assets/images/pills_variants/lgold-pillow-min.png" alt="" /></div>
            <div class="fon-item" onclick="changeColorPill(\'assets/images/pills_variants/dblue-pillow.png\');"><img src="assets/images/pills_variants/dblue-pillow-min.png" alt="" /></div>
            <div class="fon-item" onclick="changeColorPill(\'assets/images/pills_variants/red-pillow.png\');"><img src="assets/images/pills_variants/red-pillow-min.png" alt="" /></div>
            <div class="fon-item" onclick="changeColorPill(\'assets/images/pills_variants/green-pillow.png\');"><img src="assets/images/pills_variants/green-pillow-min.png" alt="" /></div>
            <div class="fon-item" onclick="changeColorPill(\'assets/images/pills_variants/blue-pillow.png\');"><img src="assets/images/pills_variants/blue-pillow-min.png" alt="" /></div>
    ...
    <div class="form-group">
        ...
        <input class="setTextColorCh" type="checkbox" onchange="TextColorToggle();" />
   
        <div class="TextColorBox">
            <label style="margin-right: 6px;" for="inputText">Шрифт:</label>
            <select id="inputText" class="fontSelector selectpicker" name="inputText" onchange="changeFontText()">
                <option selected="selected">Arial Black</option>
        ...
        <label style="margin-top: 5px;" for="inputText">Надпись:</label><br /> 
        <textarea id="inputText" class="entered-text form-control input-small no-resize" onkeyup="addTextOnCanvas()"></textarea><br />
        
        <label for="setTextColor">Цвет текста:</label>
        <div class="color color-text setTextColor" style="height: 20px; width: 20px; display: inline-block; vertical-align: middle; margin: 0px 2px; background: black;"> </div>
        <br /> <label for="strokeCheckbox">Обводка:</label> 
        <input class="strokeCheckbox" type="checkbox" onchange="setStroke();" /> 
        <label for="strokeColorCheckbox">Цвет обводки:</label>
        <div class="color color-stroke strokeColor" style="height: 20px; width: 20px; display: inline-block; vertical-align: middle; margin: 0px 2px; background: black;"> </div>
        <div id="slider"></div>
        </div>
    </div>
    <div class="form-group"><form id="my_form" action="/assets/php_constr/handler.php" method="post" enctype="multipart/form-data"><label style="margin-right: 5px;" for="you-image">Своя картинка:</label> <span class="btn btn-default btn-file"> Выбрать <input id="you-image" type="file" name="images" onchange="$(\'#my_form\').submit()" /> </span> <input id="submit" style="display: none;" type="submit" value="Отправить" /></form></div>
    <button class="btn-lg btn-success" style="width: 330px; margin-left: 5px; border: none;"> Положить в корзину </button></div>
    </div>
    <div style="clear: both;"></div>
    </div>',
    'richtext' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1456762995,
    'editedby' => 1,
    'editedon' => 1457092968,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1456762980,
    'publishedby' => 1,
    'menutitle' => 'Подушки',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'uslugi/pechat-na-podushkax.html',
    'uri_override' => 0,
    ...
    array (
      0 => 'image',
      1 => 'assets/images/goods_examples/pills-examples.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'constr_addr',
      1 => '<script src="assets/js/pills-constr.js"></script>',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<div class="container" style="max-width:1024px;">
	    ...
	    <div class="breadcrumbs"><li><a href="/">Главная</a></li><li class=\'active\'>Подушки</li></div>
	</div>
    <div style="margin: 0 auto 80px; font-family: \'Roboto Light\', \'Calibry\';">
<h2>Конструктор подушек</h2>
<hr />
<div class="container inclide_box" style="margin-top: 20px;">
<div class="phone-design-box col-xs-6 canvas-block">
...
<script src="assets/js/pills-constr.js"></script>
...
<script src="assets/js/jquery-ui.min.js"></script>
',
    '[[*constr_addr?]]' => '<script src="assets/js/pills-constr.js"></script>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
