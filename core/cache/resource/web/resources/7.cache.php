<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Сувениры с вашими фото',
    'longtitle' => '',
    'description' => '',
    'alias' => 'suveniryi-s-vashimi-foto',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    'parent' => 4,
    'isfolder' => 0,
    'introtext' => 'Мы предлагаем кружки, подушки, сумки, зеркала, камни, коврики, тарелки, календари, магнитики и многое другое, украшенные выбранными Вами изображениями.',
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1456763149,
    'editedby' => 1,
    'editedon' => 1457093852,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1456763100,
    'publishedby' => 1,
    'menutitle' => 'Сувениры',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'uslugi/suveniryi-s-vashimi-foto.html',
    'uri_override' => 0,
    ...
    array (
      0 => 'image',
      1 => 'assets/images/goods_examples/cups_examples.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<div class="container" style="max-width:1024px;">
	    ...
	    <div class="breadcrumbs"><li><a href="/">Главная</a></li><li class=\'active\'>Сувениры</li></div>
	</div>
