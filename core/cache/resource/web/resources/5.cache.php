<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Печать на чехлах',
    'longtitle' => '',
    'description' => '',
    'alias' => 'pechat-na-chexlax',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    'parent' => 4,
    'isfolder' => 1,
    'introtext' => 'Печать на чехлах, любого текста и изображения. Создай в нашем конструкторе чехол своей мечты.',
    'content' => '<h2>Генератор чехлов на телефон</h2>
		<hr>

		<div class="container inclide_box" style="margin-top:20px; margin-bottom: 70px;">
				<div class="phone-design-box col-xs-6 canvas-block">
					<div class="form-group resize-buttons">
						<button class="plus_button" onclick="scalling(0.1)"></button>
						<button class="minus_button" onclick="scalling(-0.1)"></button>						
					</div>
					<canvas id="map_layout" height="500" width="500"></canvas>		
							
				</div>
				<div class="col-xs-6 pull-right">
					<h4 class="phone_title_cr">Чехол для <span class="phone_model_text"></span> <span class="price_phone_cr"><span class="price_phone_value">500</span> Руб.</span></h4>
					<h3 class="constr_h3">Выберите модель телефона:</h3>
					<select class="phoneSelector selectpicker" name="" id="" onchange="changeColorPhone()">
						<option value="/assets/images/phone_variants/iphone_6_" price="700" selected="">Iphone 6/6s</option>
						<option value="/assets/images/phone_variants/iphone_6_plus_" price="700" selected="">Iphone 6 plus</option>
						<option value="/assets/images/phone_variants/iphone_5_" price="600">Iphone 5/5s</option>
						<option value="/assets/images/phone_variants/iphone_5c_" price="600">Iphone 5c</option>
						<option value="/assets/images/phone_variants/iphone_4_" price="500">Iphone 4/4s</option>
						<option value="/assets/images/phone_variants/ipad_mini_" price="500">Ipad Mini</option>
						<option value="/assets/images/phone_variants/samsung_galaxy_note_" price="500">Samsung Galaxy Note</option>
						<option value="/assets/images/phone_variants/samsung_galaxy_s5_" price="500">Samsung S5</option>
						<option value="/assets/images/phone_variants/samsung_galaxy_s4_" price="500">Samsung S4</option>
						<option value="/assets/images/phone_variants/samsung_galaxy_s3_" price="500">Samsung S3</option>
					</select>
					<br>
					<h3 class="constr_h3">Цвет чехла:</h3>
					<input class="whiteSkin" codecolor="0" type="button" value="" onclick="changeColorPhone(1)"/>
					<input class="blackSkin" codecolor="1" type="button" value="" onclick="changeColorPhone(2)"/>
					<input class="transpentSkin" codecolor="2" type="button" value="" onclick="changeColorPhone(3)"/>

					<div class="form-group">
						<label for="setBgColorCh">Добавить заливку:</label>
					    <input type="checkbox" class="setBgColorCh" onchange="bgColorToggle();" />
					    <div class="bgColorBox">
						    <label for="setBgColor">Цвет заливки:</label>	
						    <div class="color color-bg setBgColor" style="height: 20px; width: 20px; background: white; display:inline-block; vertical-align: middle; margin: 0px 2px;"></div>
						</div>
					</div>

					<div class="form-group">
						<label for="setTextCh">Добавить фон:</label>
						<input type="checkbox" class="setFonCh" onchange="FonToggle();" />
					    <div class="FonBox">
						    <div class="fon-item" onclick="setFon(\'/assets/images/default_phone_bgs/fon-1.jpg\');">
						    	<img src="/assets/images/default_phone_bgs/fon-1-min.jpg"/>
						    </div>

						    <div class="fon-item" onclick="setFon(\'/assets/images/default_phone_bgs/fon-2.jpg\');">
						    	<img src="/assets/images/default_phone_bgs/fon-2-min.jpg"/>
						    </div>	

						    <div class="fon-item" onclick="setFon(\'/assets/images/default_phone_bgs/fon-3.jpg\');">
						    	<img src="/assets/images/default_phone_bgs/fon-3-min.jpg"/>
						    </div>
					...
					<div class="form-group">
						<label for="setTextColorCh">Добавить текст:</label>
					    <input type="checkbox" class="setTextColorCh" onchange="TextColorToggle();" />
					    <div class="TextColorBox">
					         <label for="inputText" style="margin-right:6px;">Шрифт:</label>
					    	<select class="fontSelector selectpicker" name="inputText" id="inputText" onchange="changeFontText()">
							  	<option selected>Arial Black</option>
							  	<option>DsNarrow</option>
							  	<option>BigNoodLetitling</option>
							  	<option>Massacre</option>
							  	<option>Elzevir</option>
							</select>
					         <label for="inputText" style="margin-top:5px;">Надпись:</label><br>
					         <textarea onkeyup="addTextOnCanvas()" class="entered-text form-control input-small no-resize" id="inputText" placeholder="Введите текст"></textarea><br>
						    <label for="setTextColor">Цвет текста:</label>	
						    <div class="color color-text setTextColor" style="height: 20px; width: 20px; display: inline-block; 
    vertical-align: middle; margin: 0px 2px; background: black;"></div>
    						<br>
    						<label for="strokeCheckbox">Обводка:</label>	
						    <input type="checkbox" class="strokeCheckbox" onchange="setStroke();" />
						    <label for="strokeColorCheckbox">Цвет обводки:</label>	
						    <div class="color color-stroke strokeColor" style="height: 20px; width: 20px; display: inline-block; 
    vertical-align: middle; margin: 0px 2px; background: black;"></div>
					    	<div id="slider"></div>
						</div>						
					</div>
					...
					<div class="form-group">
						<form action="/assets/php_constr/handler.php" method="post" id="my_form" enctype="multipart/form-data">
						  <label for="you-image" style="margin-right:5px;">Своя картинка:</label>
						  <span class="btn btn-default btn-file">
						    Выбрать <input type="file" name="images" id="you-image" onchange="$(\'#my_form\').submit()">
							</span>
						  <input type="submit" style="display:none;" id="submit" value="Отправить">
						</form>
					</div>
					<button class="btn-lg btn-success" style="width:330px; margin-left: 5px; border: none;">
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1456762450,
    'editedby' => 1,
    'editedon' => 1457093673,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1456762440,
    'publishedby' => 1,
    'menutitle' => 'Чехлы',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'image',
      1 => 'assets/images/goods_examples/phone_print.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'constr_addr',
      1 => '<script src="assets/js/phone-constr.js"></script>',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<div class="container" style="max-width:1024px;">
	    ...
	    <div class="breadcrumbs"><li><a href="/">Главная</a></li><li class=\'active\'>Чехлы</li></div>
	</div>
    <h2>Генератор чехлов на телефон</h2>
		<hr>
...
<script src="assets/js/phone-constr.js"></script>
...
<script src="assets/js/jquery-ui.min.js"></script>
',
    '[[*constr_addr?]]' => '<script src="assets/js/phone-constr.js"></script>',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
