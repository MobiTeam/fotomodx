window.onload = function(){
	   ...
	   changeColorPill('assets/images/pills_variants/gold-pillow.png');	 
...
function openSelectedPill(imgSrc){
	console.log(imgSrc);
...
/////////////////////////////////////////////// 
/// Выбрать цвет чехла подушки [28.02.16]   ///
/////////////////////////////////////////////// 

function changeColorPill(color){
	...
	imgObj.onload = function() {
		openSelectedPill(imgObj.src);
	}

	imgObj.onerror = function() {
		alert("Подушки в данной расцветке нет.");
	} 
}
...
//////////////////////////////////////////////////////////////////
////  Функция изменения масштаба изображения [04.03.2016]       //
//////////////////////////////////////////////////////////////////
